-- From https://raw.githubusercontent.com/Weol/wuma/5de6d24ccdadc1628bc12f19993624f36c8df9e9/lua/wuma/client/vgui/vgui_slider.lua
...
function PANEL:SetValue(value)
    if self.min_override and (value == self.min_override[1]) then
        self.wang:SetText(self.min_override[2])
    elseif self.max_override and (value == self.max_override[1]) then
        self.wang:SetText(self.max_override[2])
    else
        self.wang:SetText(value)
    end
    
    self.wang:SetValue(value)
    self.slider:SetSlideX(value / self.wang:GetMax())
end
...
vgui.Register("SrvDupeESSlider", PANEL, 'DPanel');